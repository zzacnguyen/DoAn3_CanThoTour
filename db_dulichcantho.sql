...
(1, 'Phương Nam Restaurant', 'Bình dân, phù hợp cho trẻ em, nhóm', 1, NULL, NULL),
(2, 'Trà sữa BoBaPop', 'Ấm cúng, bình dân, nhóm', 1, NULL, NULL),
(3, 'Mekong Restaurant', 'Bình dân, phù hợp cho trẻ em, nhóm', 1, NULL, NULL),
(4, 'Cafe Hoa Cau', 'Ấm cúng, bình dân, nhóm', 1, NULL, NULL),
(5, 'Lotus Coffee', 'Ấm cúng, bình dân, phù hợp cho trẻ em. Góc nhìn sông đẹp', 1, NULL, NULL),
(6, 'Nhà Hàng Sao Hôm', 'Rượu cocktail ngon, ấm cúng, bình dân', 1, NULL, NULL),
(7, 'Xôi Gà Uyên Uyên', 'Bình dân', 1, NULL, NULL),
(8, 'Khu ẩm thực Chợ đêm Bến Ninh Kiều', 'Thức ăn, nước uống đa dạng', 1, NULL, NULL),
(9, 'Cà phê Hợp Phố', 'Đang cập nhật', 1, NULL, NULL),
(10, 'Amavo Coffee Shop\r\n', 'Đang cập nhật', 1, NULL, NULL),
(11, 'Quán Trà Sữa Miss Donut 1\r\n', 'Đang cập nhật', 1, NULL, NULL),
(12, 'Nhà Hàng Gony Spa Cafe Lounge', 'Đang cập nhật', 1, NULL, NULL),
(13, 'Sìl Mỳ', 'Đang cập nhật', 1, NULL, NULL);
...
(2, 'Ninh Kieu Riverside Hote', 'ninhkieuhotel.vn', 'Located in the center of Ninh Kieu quay, Can Tho city, the 4 star Ninh Kieu Riverside Hotel, with the unique and impressive architecture in Can Tho city, has created its brand and prestige from the opening.\r\n\r\nWith the best location in Can Tho city, fully modern facilities equipped, professional & enthusiastic staff, and experienced management team as well. We believe that you will be satisfied when enjoying our services.', 2, NULL, NULL),
(3, 'Khách sạn TTC', 'ttccantho.com', 'TTC Hotel Premium - Cần Thơ, một điểm đến lý tưởng, tọa lạc tại Bến Ninh Kiều, Cần Thơ. Chỉ mất 2 phút là Bạn có thể thưởng thức phong cảnh tuyệt đẹp tại Bến Ninh kiều. Khách sạn cao 10 tầng, tại đây bạn có thể ngắm nhìn toàn bộ phong cảnh thành phố và sông Hậu. Với số lượng 107 phòng được trang bị tốt, với không gian rộng rãi thoáng mái sẽ làm cho bạn cảm thấy thật tuyệt vời khi ở tại đây. Bất cứ khi nào bạn đến với TTC Hotel Premium - Cần Thơ cho một kỳ nghỉ hoặc công tác, Bạn sẽ được hân hoan chào đón bởi sự chuyên nghiệp, thân thiện, mến khách từ nhân viên của chúng tôi.', 2, NULL, NULL),
(4, 'International Hotel', 'internationalhotel.vn', 'Khách sạn International vinh hạnh là khách sạn đạt chuẩn 3 sao đầu tiên của Thành phố Cần Thơ với địa thế chiến lược tọa lạc ngay trung tâm Thành phố. Hơn 30 năm cùng sự chuyển mình  của thành phố, khách sạn International được xây dựng lại và khai trương vào tháng 4 năm 2015 với mong muốn trở thành một trong những khách sạn hiện đại, sang trọng và đáng tin cậy nhất nhằm phục vụ nhu cầu của quý khách. Đến với  khách sạn International chúng tôi, quý khách có thể tận hưởng hoàn toàn vẻ đẹp tuyệt vời của dòng sông Hậu và công viên bến Ninh Kiều.  Khách sạn được trang bị 56 phòng với nội thất thiết kế cao cấp, đầy đủ tiện nghi và hiện đại. Bên cạnh đó, khách sạn còn có nhà hàng , hội trường phục vụ Hội nghị, tập huấn, quán cà  phê và bar đáp ứng nhu cầu phục vụ mọi đối tượng khách hàng.', 2, NULL, NULL),
(5, 'Khách Sạn Kim Thơ', 'kimtho.com', 'Đang cập nhật', 2, NULL, NULL),
(6, 'Khách sạn Caravelle Cần Thơ', 'Đang cập nhật', 'Đang cập nhật', 2, NULL, NULL),
(7, 'Khách sạn Tây Hồ', 'Đang cập nhật', 'Đang cập nhật', 2, NULL, NULL),
(8, 'Nam Bộ Boutique Hotel & restaurants ', 'nambocantho.com', 'Đang cập nhật', 2, NULL, NULL);
...
(2, 'Hội chợ Nông nghiệp Quốc tế Việt Nam 2017', '2017-12-13', '2017-12-22', 6, 1, NULL, NULL),
(3, 'Mua 1 tặng 1', '2017-12-22', '2017-12-23', 7, 2, NULL, NULL);
