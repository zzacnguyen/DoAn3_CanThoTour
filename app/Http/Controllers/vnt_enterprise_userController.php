...
class vnt_enterprise_userController extends Controller
{
    public function getServices($user_id)
    {
        ...
        ->select('vnt_services.id','sv_description', 'sv_open','sv_close','sv_lowest_price','sv_highest_price',  'tourist_places_id', 'sv_types','sv_status', 'image_banner', 
        ...
        ->join('vnt_enterprise_user','vnt_user.user_id', '=', 'vnt_enterprise_user.user_id')
