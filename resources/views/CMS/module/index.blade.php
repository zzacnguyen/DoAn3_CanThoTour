    ...
    <div class="scrollable-content scrollable-slim-sidebar">
        <div class="pad10A">
            ...
            <ul class="chat-box">
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="{{ asset('resourceAdminTemplate/assets/image-resources/people/testimonial1.jpg')}}" alt="">
                ...
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="{{ asset('resourceAdminTemplate/assets/image-resources/people/testimonial2.jpg')}}" alt="">
                        <div class="small-badge bg-green"></div>
                    </div>
                    <b>
                        Carl Gamble
                ...
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="{{ asset('resourceAdminTemplate/assets/image-resources/people/testimonial3.jpg')}}" alt="">
                        <div class="small-badge bg-green"></div>
                    </div>
                    <b>
                        Michael Poole
                ...
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="{{ asset('resourceAdminTemplate/assets/image-resources/people/testimonial4.jpg')}}" alt="">
                        <div class="small-badge bg-green"></div>
                    </div>
                    <b>
                        Bill Green
                ...
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="{{ asset('resourceAdminTemplate/assets/image-resources/people/testimonial5.jpg')}}" alt="">
                        <div class="small-badge bg-green"></div>
                    </div>
                    <b>
                        Cheryl Soucy
            ...
            <ul class="chat-box">
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="{{ asset('resourceAdminTemplate/assets/image-resources/people/testimonial6.jpg')}}" alt="">
                ...
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="{{ asset('resourceAdminTemplate/assets/image-resources/people/testimonial7.jpg')}}" alt="">
                        <div class="small-badge bg-orange"></div>
                    </div>
                    <b>
                        Dan Garcia
                ...
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="{{ asset('resourceAdminTemplate/assets/image-resources/people/testimonial8.jpg')}}" alt="">
                        <div class="small-badge bg-orange"></div>
                    </div>
                    <b>
                        Edward Bridges
...
<script type="text/javascript" src="{{ asset('resourceAdminTemplate/assets/widgets/charts/sparklines/sparklines.js')}}"></script>
<script type="text/javascript" src="{{ asset('resourceAdminTemplate/assets/widgets/charts/sparklines/sparklines-demo.js')}}"></script>

<!-- Flot charts -->

<script type="text/javascript" src="{{ asset('resourceAdminTemplate/assets/widgets/charts/flot/flot.js')}}"></script>
<script type="text/javascript" src="{{ asset('resourceAdminTemplate/assets/widgets/charts/flot/flot-resize.js')}}"></script>
<script type="text/javascript" src="{{ asset('resourceAdminTemplate/assets/widgets/charts/flot/flot-stack.js')}}"></script>
<script type="text/javascript" src="{{ asset('resourceAdminTemplate/assets/widgets/charts/flot/flot-pie.js')}}"></script>
<script type="text/javascript" src="{{ asset('resourceAdminTemplate/assets/widgets/charts/flot/flot-tooltip.js')}}"></script>
<script type="text/javascript" src="{{ asset('resourceAdminTemplate/assets/widgets/charts/flot/flot-demo-1.js')}}"></script>
