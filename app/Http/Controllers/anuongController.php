...
class anuongController extends Controller
{
    ...
    { 
        ...
        ->select('dlct_anuong.dv_iddichvu AS id','au_ten','dlct_hinhanh.id AS id_hinhanh','dlct_hinhanh.chitiet1')
    ...
    {
        $an_uong = DB::table('dlct_anuong')
        ->select('dlct_anuong.dv_iddichvu AS id','au_ten', 'dlct_diadiem.dd_diachi','dlct_diadiem.dd_sodienthoai',
        ...
        ->where('dlct_anuong.dv_iddichvu',$id)
        ->get();
        $encode=json_encode($an_uong);
        return $encode;
    }
